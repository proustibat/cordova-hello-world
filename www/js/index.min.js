!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";function r(e){return e&&e.__esModule?e:{default:e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0}),t.HelloWorld=void 0;var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(1),s=r(a);window.$=s.default,window.jQuery=s.default;var u=t.HelloWorld=function(){function e(){i(this,e),console.debug("Hello HelloWorld"),document.addEventListener("deviceready",this.onDeviceReady.bind(this),!1)}return o(e,[{key:"onDeviceReady",value:function(e){console.debug("[HelloWorld#onDeviceReady] event = ",e),this.receivedEvent("deviceready")}},{key:"receivedEvent",value:function(e){console.debug("[HelloWorld#receivedEvent] id = ",e),(0,s.default)("#"+e).removeClass("blink");var t=document.getElementById(e),n=t.querySelector(".listening"),r=t.querySelector(".received");n.setAttribute("style","display:none;"),r.setAttribute("style","display:block;"),this.$el=(0,s.default)(".app"),this.createButton()}},{key:"createButton",value:function(){console.debug("[HelloWorld#createButton]"),this.$button=(0,s.default)("<button/>").addClass("btn-click blink").html("Click Me"),this.$el.append(this.$button),this.$button.on("click",this.onButtonClick.bind(this))}},{key:"onButtonClick",value:function(){console.debug("[HelloWorld#onButtonClick]"),this.$image=(0,s.default)("<img/>"),this.$el.append(this.$image),this.camera=navigator.camera;var e={quality:100,destinationType:this.camera.DestinationType.FILE_URI,sourceType:this.camera.PictureSourceType.CAMERA,encodingType:this.camera.EncodingType.JPEG,mediaType:this.camera.MediaType.PICTURE};console.log(e),this.camera.getPicture(this.onGetPictureSuccess.bind(this),this.onGetPictureError.bind(this),e)}},{key:"onGetPictureSuccess",value:function(e){console.debug("[HelloWorld#onGetPictureSuccess]"),this.$el.css({background:"url("+e+")",backgroundSize:"cover"})}},{key:"onGetPictureError",value:function(e){console.debug("[HelloWorld#onGetPictureError] message = ",e)}}]),e}();(0,s.default)(document).ready(function(){console.debug("jQuery Ready, now instantiate HelloWorld");new u})},function(e,t,n){var r,i;/*!
